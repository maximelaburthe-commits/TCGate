...
for(const token of [
  "TCGate Alpha 0.1 Candidate 11",'authToken','SESSION_STORAGE_KEY','MEDIA_PREFS_KEY',
...
for(const token of [
  "const VERSION = 'tcgate-alpha-0.1-candidate-11'",'crypto.randomInt','sessionToken','timingSafeEqual',
