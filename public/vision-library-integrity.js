(function initVisionLibraryIntegrity(root, factory) {
  ...
  function validateCache(cache, { fingerprint, sourceCount }) {
  ...
  function assess({ sourceReferences = 0, loadedReferences = 0, failedReferences = 0, cacheStatus = 'miss', cacheSourceReferences = null, cacheLibrarySize = null, baselineMinimum = 0, source = null, sourceUrl = null, sourceError = null, failed = [] } = {}) {
    let reason = null;
    ...
    return Object.freeze({ sourceReferences, loadedReferences, failedReferences, cacheStatus, cacheSourceReferences, cacheLibrarySize, degraded: Boolean(reason), reason, baselineMinimum, source, sourceUrl, sourceError, failed: failed.slice(0, 25) });
  }
